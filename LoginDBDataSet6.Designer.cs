...
namespace User_Registration {
    ...
    public partial class LoginDBDataSet6 : global::System.Data.DataSet {
        ...
        public partial class billsDataTable : global::System.Data.TypedTableBase<billsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public billsRow AddbillsRow(string user_name, decimal bill) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public billsRow FindByuser_name(string user_name) {
        ...
        public partial class billsRow : global::System.Data.DataRow {
            ...
            public int Id {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Id\' in table \'bills\' is DBNull.", e);
                    }
                }
                set {
            ...
            public decimal bill {
                get {
                    try {
                        return ((decimal)(this[this.tablebills.billColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace User_Registration.LoginDBDataSet6TableAdapters {
    ...
    public partial class billsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[bills] WHERE (((@IsNull_Id = 1 AND [Id] IS NULL) OR ([Id] = @O" +
                "riginal_Id)) AND ([user_name] = @Original_user_name) AND ((@IsNull_bill = 1 AND " +
                "[bill] IS NULL) OR ([bill] = @Original_bill)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[bills] ([Id], [user_name], [bill]) VALUES (@Id, @user_name, @b" +
                "ill);\r\nSELECT Id, user_name, bill FROM bills WHERE (user_name = @user_name)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[bills] SET [Id] = @Id, [user_name] = @user_name, [bill] = @bill WHERE (((@IsNull_Id = 1 AND [Id] IS NULL) OR ([Id] = @Original_Id)) AND ([user_name] = @Original_user_name) AND ((@IsNull_bill = 1 AND [bill] IS NULL) OR ([bill] = @Original_bill)));
SELECT Id, user_name, bill FROM bills WHERE (user_name = @user_name)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, user_name, bill FROM dbo.bills";
        ...
        public virtual int Fill(LoginDBDataSet6.billsDataTable dataTable) {
        ...
        public virtual LoginDBDataSet6.billsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet6.billsDataTable dataTable = new LoginDBDataSet6.billsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet6.billsDataTable dataTable) {
        ...
        public virtual int Delete(global::System.Nullable<int> Original_Id, string Original_user_name, global::System.Nullable<decimal> Original_bill) {
            ...
            if ((Original_bill.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((decimal)(Original_bill.Value));
            }
            else {
        ...
        public virtual int Insert(global::System.Nullable<int> Id, string user_name, global::System.Nullable<decimal> bill) {
            if ((Id.HasValue == true)) {
        ...
        public virtual int Update(global::System.Nullable<int> Id, string user_name, global::System.Nullable<decimal> bill, global::System.Nullable<int> Original_Id, string Original_user_name, global::System.Nullable<decimal> Original_bill) {
            if ((Id.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> Id, global::System.Nullable<decimal> bill, global::System.Nullable<int> Original_Id, string Original_user_name, global::System.Nullable<decimal> Original_bill) {
            return this.Update(Id, Original_user_name, bill, Original_Id, Original_user_name, Original_bill);
        }
    }
