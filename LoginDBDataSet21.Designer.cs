...
namespace User_Registration {
    ...
    public partial class LoginDBDataSet2 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/LoginDBDataSet21.xsd";
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table1Row AddTable1Row(string UserName, string FirstName, string Contact, string Address, string LastName, string Password) {
        ...
        public partial class Table1Row : global::System.Data.DataRow {
            ...
            public string Contact {
                get {
                    try {
                        return ((string)(this[this.tableTable1.ContactColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableTable1.ContactColumn] = value;
                }
            }
            ...
            public bool IsContactNull() {
                return this.IsNull(this.tableTable1.ContactColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetContactNull() {
                this[this.tableTable1.ContactColumn] = global::System.Convert.DBNull;
            }
...
namespace User_Registration.LoginDBDataSet2TableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table1] WHERE (([UserName] = @Original_UserName) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table1] ([UserName], [FirstName], [Contact], [Address], [LastName], [Password]) VALUES (@UserName, @FirstName, @Contact, @Address, @LastName, @Password);
SELECT UserName, FirstName, Contact, Address, LastName, Password FROM Table1 WHERE (UserName = @UserName)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table1] SET [UserName] = @UserName, [FirstName] = @FirstName, [Contact] = @Contact, [Address] = @Address, [LastName] = @LastName, [Password] = @Password WHERE (([UserName] = @Original_UserName) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT UserName, FirstName, Contact, Address, LastName, Password FROM Table1 WHERE (UserName = @UserName)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserName, FirstName, Contact, Address, LastName, Password FROM dbo.Table1";
        ...
        public virtual int Fill(LoginDBDataSet2.Table1DataTable dataTable) {
        ...
        public virtual LoginDBDataSet2.Table1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet2.Table1DataTable dataTable = new LoginDBDataSet2.Table1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet2.Table1DataTable dataTable) {
        ...
        public virtual int Delete(string Original_UserName, string Original_FirstName, string Original_Contact, string Original_Address, string Original_LastName, string Original_Password) {
        ...
        public virtual int Insert(string UserName, string FirstName, string Contact, string Address, string LastName, string Password) {
            if ((UserName == null)) {
        ...
        public virtual int Update(string UserName, string FirstName, string Contact, string Address, string LastName, string Password, string Original_UserName, string Original_FirstName, string Original_Contact, string Original_Address, string Original_LastName, string Original_Password) {
            if ((UserName == null)) {
                throw new global::System.ArgumentNullException("UserName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string Contact, string Address, string LastName, string Password, string Original_UserName, string Original_FirstName, string Original_Contact, string Original_Address, string Original_LastName, string Original_Password) {
            return this.Update(Original_UserName, FirstName, Contact, Address, LastName, Password, Original_UserName, Original_FirstName, Original_Contact, Original_Address, Original_LastName, Original_Password);
        }
    }
