...
namespace User_Registration {
    ...
    public partial class LoginDBDataSet5 : global::System.Data.DataSet {
        ...
        public partial class SampleDataTable : global::System.Data.TypedTableBase<SampleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SampleRow AddSampleRow(int Id, string Name, string State) {
        ...
        public partial class SampleRow : global::System.Data.DataRow {
            ...
            public string State {
                get {
                    try {
                        return ((string)(this[this.tableSample.StateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'State\' in table \'Sample\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableSample.StateColumn] = value;
                }
            }
            ...
            public bool IsStateNull() {
                return this.IsNull(this.tableSample.StateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetStateNull() {
                this[this.tableSample.StateColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace User_Registration.LoginDBDataSet5TableAdapters {
    ...
    public partial class SampleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Sample] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AN" +
                "D [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_State = 1 AND [Sta" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Sample] ([Id], [Name], [State]) VALUES (@Id, @Name, @State);\r\n" +
                "SELECT Id, Name, State FROM Sample WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Sample] SET [Id] = @Id, [Name] = @Name, [State] = @State WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_State = 1 AND [State] IS NULL) OR ([State] = @Original_State)));
SELECT Id, Name, State FROM Sample WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, State FROM dbo.Sample";
        ...
        public virtual int Fill(LoginDBDataSet5.SampleDataTable dataTable) {
        ...
        public virtual LoginDBDataSet5.SampleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet5.SampleDataTable dataTable = new LoginDBDataSet5.SampleDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet5.SampleDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string Name, string State) {
        ...
        public virtual int Update(int Id, string Name, string State, int Original_Id, string Original_Name, string Original_State) {
        ...
        public virtual int Update(string Name, string State, int Original_Id, string Original_Name, string Original_State) {
            return this.Update(Original_Id, Name, State, Original_Id, Original_Name, Original_State);
        }
    }
